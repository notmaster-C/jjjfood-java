	...
	<view class="login-container" :style="'height: '+phoneHeight+'px;'">
		...
		<view class="p-30-75" v-if="isLogin==1">
			...
			<view class="group-bd">
				...
				<view class="form-level d-s-c" >
					<view class="val flex-1 input_botom"><input type="text" password="true" v-model="logingPassword"
							placeholder="请输入密码" /></view>
				</view>
		...
		<view style="padding-top: 80rpx;" class="btns p-30-75" v-if="isLogin==2"><button type="default"
				@click="registerSub">注册</button></view>
		<view style="padding-top: 80rpx;" class="btns p-30-75" v-if="isLogin==1"><button type="default"
				@click="formSubmit">登录</button></view>
		<view style="padding-top: 80rpx;" class="btns p-30-75" v-if="isLogin==0"><button type="default"
