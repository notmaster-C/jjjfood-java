<template>
	<view :data-theme='theme()' :class="theme() || ''">
		<view class="order-box" v-if="!loadding">
			...
			<view class="d-s-c mt20 mb40" v-if="detail.payStatus == 10 && detail.orderStatus != 20">
				<view class="f26">交易将在：<text class="orange">{{detail.payEndTime}}</text>后关闭，请及时付款</view>
			</view>
			<view class="top-state"
				v-if="detail.orderType!=1 && detail.deliveryType==10 && detail.orderStatus == 10">
			...
			<view class="order-content">
				<view class="shop-name border-b">{{detail.supplier && detail.supplier.name}}</view>
			...
			<view class="other_box">
				...
				<view class="meal_item">
					<view>支付金额</view>
					<view class="right">{{detail.payPrice}}</view>
				</view>
				<view class="meal_item">
					<view>支付方式</view>
					<view class="right">{{detail.payTypeText}}</view>
				</view>
				<view class="meal_item">
					<view>备注</view>
					<view class="right">
