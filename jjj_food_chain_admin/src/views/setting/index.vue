<template>
  ...
  <div class="product-add">
    ...
    <el-form ref="form" :model="form" label-width="150px">
      ...
      <el-form-item label="商城登录logo" prop="shopLogoImg">
        <el-input v-model="form.shopLogoImg" placeholder="商城登录logo" class="max-w460"></el-input>
        <div class="tips">
      ...
      getParams() {
        ...
        SettingApi.serviceDetail({}, true).then(res => {
            ...
            if (res.data.weixinService) {
              ...
              self.form.weixinService.isOpen = parseInt(self.form.weixinService.isOpen);
            }
            self.loading = false;
          })
          .catch(error => {
