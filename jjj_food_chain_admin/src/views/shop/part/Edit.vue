<template>
  ...
  <el-dialog title="编辑平台" v-model="dialogVisible" @close='dialogFormVisible' :close-on-click-modal="false"
    ...
    <el-form size="small" :model="form" ref="form" :rules="rules">
      ...
      <el-form-item label="平台名称" :label-width="formLabelWidth" prop="appName">
        <el-input v-model="form.appName" autocomplete="off" placeholder="请输入平台名称"></el-input>
      </el-form-item>
      <el-form-item label="过期时间" :label-width="formLabelWidth" prop="expireTime">
        <el-date-picker v-model="form.expireTime" type="date" placeholder="过期时间" value-format="YYYY-MM-DD"
          :disabled="form.noExpire"></el-date-picker>
        <el-checkbox v-model="form.noExpire" class="pl16">永不过期</el-checkbox>
      </el-form-item>
      <el-form-item label="平台账户名" :label-width="formLabelWidth" prop="userName">
        <el-input v-model="form.userName" autocomplete="off" placeholder="请输入平台账户名"></el-input>
