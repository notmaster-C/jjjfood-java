<template>
  <div class="home" v-loading="loading">
    <div class="operation-wrap" style="background-color: #FFFFFF;" v-if="userType==0">
      <el-row>
        <el-col :span="6" class="d-c-c">
          <div class="grid-content blue">
            <div class="info">
              <h3>{{topData.supplierTotal}}</h3>
              <p>门店总量</p>
            </div>
          </div>
        </el-col>
    ...
    <div class="operation-wrap" style="background-color: #FFFFFF;" v-if="userType==1">
      <el-row>
        <el-col :span="6" class="d-c-c">
          <div class="grid-content blue">
            <div class="info">
        ...
        <el-col :span="6" class="d-c-c">
          <div class="grid-content yellow ">
            <div class="info">
              <h3 style="font-size: 32px;">{{Math.floor(topData.totalMoney)}}</h3>
              <p>销售总额(元)</p>
            </div>
          </div>
        </el-col>
    ...
    <div class="home-index">
      ...
      <div class="flex-1">
        <div class="main-index">
          ...
          <el-row class="border-b-l" v-if="userType==0">
            <el-col :span="6">
              <div class="grid-content">
                <div class="info t-c">
                  <p class="des">销售额(元)</p>
                  <h3>{{todayData.orderTotalPriceT}}</h3>
                  <p class="yesterday">昨日：{{todayData.orderTotalPriceY}}</p>
                </div>
              </div>
            </el-col>
            <el-col :span="6">
              <div class="grid-content">
                <div class="info">
                  <p class="des">支付订单数</p>
                  <h3>{{todayData.orderTotalT}}</h3>
                  <p class="yesterday">昨日：{{todayData.orderTotalY}}</p>
                </div>
              </div>
            </el-col>
            <el-col :span="6">
              <div class="grid-content">
                <div class="info">
                  <p class="des">新增用户数</p>
                  <h3>{{todayData.newUserTotalT}}</h3>
                  <p class="yesterday">昨日：{{todayData.newUserTotalY}}</p>
                </div>
              </div>
            </el-col>
            <el-col :span="6">
              <div class="grid-content">
                <div class="info">
                  <p class="des">新增商户</p>
                  <h3>{{todayData.newSupplierTotalT}}</h3>
                  <p class="yesterday">昨日：{{todayData.newSupplierTotalY}}</p>
                </div>
              </div>
            </el-col>
          </el-row>
          <el-row class="border-b-l" v-if="userType==1">
            <el-col :span="6">
              <div class="grid-content">
                <div class="info">
                  <p class="des">销售额(元)</p>
            ...
            <el-col :span="6">
              <div class="grid-content">
                <div class="info">
                  <p class="des">下单用户数</p>
                  <h3>{{todayData.orderUserTotalT}}</h3>
                  <p class="yesterday">昨日：{{todayData.orderUserTotalY}}</p>
                </div>
              </div>
            </el-col>
            <!-- <el-col :span="6">
              <div class="grid-content">
                <div class="info">
                  <p class="des">预计收入</p>
                  <h3>{{todayData.incomeMoney.tday}}</h3>
                  <p class="yesterday">昨日：{{todayData.incomeMoney.ytd}}</p>
                </div>
              </div>
            </el-col> -->
          </el-row>
            ...
            <div class="matters">
              <div class="box ">
                <ul class="matters_item">
                  <li><span class="fb">{{waitData.orderDisposal}}</span>待处理订单</li>
                  <li><span class="fb">{{waitData.stockProduct}}</span>库存告急</li>
                </ul>
              </div>
            </div>
          </el-col>
    ...
    methods: {
      ...
      getData() {
        ...
        IndexApi.getCount(true).then(data => {
          self.loading = false;
          Object.assign(self.productData, data.data.productData);
          self.topData = data.data.topData;
          self.waitData = data.data.waitData;
          self.todayData = data.data.todayData;
        }).catch(error => {
