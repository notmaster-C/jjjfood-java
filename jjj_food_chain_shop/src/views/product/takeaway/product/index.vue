  ...
  <div class="product-list">
    ...
    <div class="common-seach-wrap">
      ...
      <el-form size="small" :inline="true" :model="searchForm" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button size="small" v-waves type="primary" icon="Search" @click="onSubmit">查询</el-button>
        </el-form-item>
      </el-form>
    </div>
    <!--添加产品-->
        ...
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
          ...
          <el-table-column fixed="right" label="操作" width="160">
            <template #default="scope">
              ...
              <el-button @click="undercarriage(scope.row,20)" type="text" size="small" v-auth="'/product/takeaway/product/state'" v-if="scope.row.productStatus!=20">下架</el-button>
