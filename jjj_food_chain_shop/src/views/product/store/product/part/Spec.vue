  ...
  <div>
    ...
    <el-form-item label="特色分类：">
      <el-radio-group v-model="form.model.specialId">
        ...
        <el-radio :label="item.categoryId" v-for="(item,index) in form.special" :key="index">{{item.name}}</el-radio>
      </el-radio-group>
    </el-form-item>
    <el-form-item label="商品单位：" :rules="[{ required: true, message: '请填写商品单位' }]" prop="model.productUnit">
      <el-autocomplete class="inline-input" v-model="form.model.productUnit" placeholder="如:大份"
