<template>
  ...
  <div class="mt16">
    <el-form-item label="规格明细：" v-if="form.sku.length > 0">
      <!--多规格表格-->
      <div>
        <el-table size="mini" :data="form.sku" border style="width: 100%; margin-top: 20px">
          <el-table-column label="规格名称">
            <template #default="scope">
              <el-form-item label="" style="margin-bottom: 0;">
                <!-- <el-input size="small" prop="specName" v-model="scope.row.specName"></el-input> -->
                <el-autocomplete class="inline-input" v-model="scope.row.specName" :fetch-suggestions="querySearch"
          ...
          <el-table-column label="价格">
            <template #default="scope">
              <el-form-item label="" style="margin-bottom: 0;">
                <el-input type="number" size="small" prop="productPrice" v-model="scope.row.productPrice"></el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column label="包装费">
            <template #default="scope">
              <el-form-item label="" style="margin-bottom: 0;">
                <el-input type="number" size="small" prop="bagPrice" v-model="scope.row.bagPrice"></el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column label="库存">
            <template #default="scope">
              <el-form-item label="" style="margin-bottom: 0;">
                <el-input type="number" size="small" prop="stockNum" v-model="scope.row.stockNum"></el-input>
              </el-form-item>
            </template>
          </el-table-column>
