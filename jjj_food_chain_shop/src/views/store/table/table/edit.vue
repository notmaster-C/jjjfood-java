<template>
  ...
  <el-dialog title="添加类型" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
    ...
    <el-form size="small" :model="form" :rules="formRules" ref="form">
      <el-form-item label="桌位编号" prop="tableNo" :label-width="formLabelWidth">
        <el-input v-model="form.tableNo" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="类型名称" prop="typeId" :label-width="formLabelWidth">
      ...
      <el-form-item label="所属区域" prop="areaId" :label-width="formLabelWidth">
      ...
      <el-form-item label="排序" prop="sort" :label-width="formLabelWidth">
        <el-input-number v-model="form.sort" :min="1" controls-position="right" style="width: 100%;" autocomplete="off"></el-input-number>
      </el-form-item>
    </el-form>
    <template #footer>
