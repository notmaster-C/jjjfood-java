		...
		<div class="product-content">
			...
			<div class="table-wrap">
				<el-row>
					...
					<el-col :span="5"
						v-if="detail['payStatus']['value'] == 10 && detail['orderStatus']['value'] == 10 && detail['order_source'] == 10"
						...
						<template #default="scope">
							<div class="product-info">
								...
								<div class="info">
									...
									<div class="gray9" v-if="scope.row.productAttr!=''">{{scope.row.productAttr}}
									</div>
									...
									<div class="price">
										<span
											:class="{'text-d-line':scope.row.isUserGrade==1,'gray6':scope.row.isUserGrade!=1}">￥
			...
			<!--门店自提核销-->
			<div
				v-if="detail.deliveryType == 20 && detail.payStatus == 20 && detail.orderStatus != 21 && detail.orderStatus != 20">
