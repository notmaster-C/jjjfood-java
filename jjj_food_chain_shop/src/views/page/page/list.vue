<template>
  ...
  <div class="d-b-s diy-preview">
    <!--手机diy容器-->
    <div class="diy-phone list-phone">
          ...
          <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading">
            ...
            <el-table-column prop="pageName" label="页面名称">
              <template #default="scope">
                ...
                <span class="red" v-if="scope.row.isDefault!=0">(默认)</span>
            ...
            <el-table-column fixed="right" label="操作" width="110">
              <template #default="scope">
                <el-button v-if="scope.row.isDefault==0" @click="setHomeClick(scope.row.pageId)" type="text" size="small" v-auth="'/page/page/setPage'">设为默认</el-button>
    ...
    methods: {
      ...
      getTableList() {
        ...
        PageApi.HomeList(Params, true).then(data => {
          ...
          self.diyData = data.data.default.pageDataJson;
