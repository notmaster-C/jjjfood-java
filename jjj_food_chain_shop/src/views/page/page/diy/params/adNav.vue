  ...
  <div>
    ...
    <div class="form-item">
      ...
      <div class="flex-1 d-s-c" style="height: 36px">
        ...
        <el-button
          ...
          @click.stop="
            $parent.onEditorResetColor(curItem.style, 'bgcolor', '#F2F2F2')
          "
          type="primary"
          link
          >重置</el-button
    ...
    <div class="form-item">
      ...
      <div class="flex-1 d-s-c" style="height: 36px">
        <el-input
          class="ml10"
          v-model="curItem.style.background1"
          placeholder="透明"
        />
        <el-input
          class="ml10"
          v-model="curItem.style.background2"
          placeholder="透明"
        />
        <view class="ml10"
          ><el-color-picker
        ...
        <el-button
          style="margin-left: 10px"
          @click.stop="ResetColor('background1', 'background2')"
          type="primary"
          link
          >重置</el-button
        >
    ...
    <el-form size="small" :model="curItem" label-width="100px">
      <div class="f16 gray3 form-subtitle">
        ...
        <span class="gray9 f12"
          >图片上传建议宽度88*88px，拖拽图片可调整图片显示顺序哦</span
        >
      </div>
                ...
                <div class="url-box mb16 flex-1 d-s-c ww100">
                  ...
                  <div class="flex-1 d-s-c" style="height: 36px">
                    ...
                    <el-button
                      style="margin-left: 10px"
                      @click.stop="
                        $parent.onEditorResetColor(element, 'textcolor', '#999')
                      "
                      type="primary"
                      link
                    >
...
export default {
  ...
  methods: {
    ...
    ResetColor(title_color1, title_color2) {
      this.$parent.onEditorResetColor(
        this.curItem.style,
        title_color1,
        "#ffffff"
      );
