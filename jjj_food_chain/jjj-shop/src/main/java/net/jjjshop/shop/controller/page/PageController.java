...
public class PageController {
    ...
    public ApiResult<Map<String,Object>> toEditPage(Integer pageId) {
        Map<String,Object> result = new HashMap<>();
    ...
    @OperationLog(name = "editPage")
    @ApiOperation(value = "editPage", response = String.class)
    public ApiResult<String> editPage(Integer pageId, String params) {
    ...
    public ApiResult<Map<String,Object>> toAddPage() {
        Map<String,Object> result = new HashMap<>();
    ...
    @OperationLog(name = "addPage")
    @ApiOperation(value = "addPage", response = String.class)
    public ApiResult<String> addPage(String params) {
