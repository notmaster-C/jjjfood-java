...
public class PrinterFactory {
    ...
    private String getPrintContent(Order order)
    {
        ...
        if(order.getDeliveryType() == DeliveryTypeEnum.WAIMAI.getValue()){
            content.append("--------------------------------<BR>");
        ...
        if(order.getDeliveryType() == DeliveryTypeEnum.ZITI.getValue() && extract != null){
            content.append("--------------------------------<BR>");
...
//            content.append("自提门店：").append(storeService.getById(order.getExtractStoreId()).getStoreName()).append("<BR>");
        ...
        if(order.getDeliveryType().intValue() == DeliveryTypeEnum.WAIMAI.getValue().intValue()){
